...
public class Pager {
	...
	//계산
	public PageVO getPage() throws Exception{
		
		
//		int currentPage, int rowCount, int displayRow, int pageCount
		...
		/*
		 * pagination.setCurrentPage(currentPage); pagination.setEndPage(endPage);
		 * pagination.setStartPage(startPage); pagination.setLastPage(lastPage);
		 * pagination.setPageCount(pageCount); pagination.setRowCount(rowCount);
		 * pagination.setDisplayRow(displayRow); pagination.setOffset(offset);
		 */
		return pagination;
	}
}
